            ...
            <div className="container py-4 lg:py-7 mt-5">
                <div className="w-[100%] px-7 py-7 md:px-14 md:py-14 lg:px-28 lg:py-28"
                    style={{
                        ...
                        backgroundImage: (pages && pages.deliveryMethod && pages.deliveryMethod.image) ?
                            `url(${process.env.REACT_APP_SERVER_URL}/${pages.deliveryMethod.image})` : undefined
                    }}
                >
                    {(pages && pages.deliveryMethod) ?
                        <div className="text-neutral-6000 dark:text-neutral-400 px-4 py-4 md:px-8 md:py-8 lg:px-16 lg:py-16 bg-[#FFFFFF80]"
                            dangerouslySetInnerHTML={{ __html: Utils.replaceEmptyTagsWithBrTag(draftToHtml(pages.deliveryMethod.text)) }}
                        /> :
                        null
                    }
                </div>
