class Utils {
   ...
   */
  static getNameInitial(name: any) {
   ...
   * @return {Object} object that contains the path string
   */
   ...
   */
  static getSignNum(number: any, positive: any, negative: any) {
    if (number > 0) {
      return positive;
    }
    if (number < 0) {
  ...
  static replaceEmptyTagsWithBrTag(htmlString: string) {
    htmlString = htmlString.replace(/<p><\/p>/gi, "<br/>");
    htmlString = htmlString.replace(/<h1><\/h1>/gi, "<br/>");
    htmlString = htmlString.replace(/<h2><\/h2>/gi, "<br/>");
    htmlString = htmlString.replace(/<h3><\/h3>/gi, "<br/>");
    htmlString = htmlString.replace(/<h4><\/h4>/gi, "<br/>");
    htmlString = htmlString.replace(/<h5><\/h5>/gi, "<br/>");
    htmlString = htmlString.replace("background-color: rgb(255,255,255);", "");
    return htmlString.replace(/<h6><\/h6>/gi, "<br/>");
  }
}
