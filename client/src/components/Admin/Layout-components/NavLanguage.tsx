...
import { SPACER } from "utils/constants/Admin/ThemeConstant";
import { baseTheme } from "config/Admin/ThemeConfig";
import Flex from "components/Admin/Shared-components/Flex";
import { css } from "@emotion/react";
import { RootState } from "store";

function getLanguageDetail(locale: any) {
  const data = lang.filter((elm: any) => elm.langId === locale);
  return data[0];
}
...
const MenuItem = (props: any) => {
  ...
  const handleLocaleChange = (langId: any) => {
