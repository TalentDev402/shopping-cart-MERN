...
interface SideNavProps {
  ...
  routeInfo: any; // Update the type as needed
  hideGroupTitle?: boolean;
  currentTheme?: string; // Update the type as needed
}
...
export const SideNav: React.FC<SideNavProps> = ({
  ...
  const sideNavTheme = useSelector(
    (state: RootState) => state.theme.sideNavTheme
  );
